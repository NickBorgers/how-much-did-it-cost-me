...
const TRENDING_SPENDING = {
  trending1: {
    label: 'Trump Military Parade (June 14)',
    value: 45_000_000,               // ~$45 million (Army estimate for June 14 parade)
    source: 'The Hill / NBC News / Army estimates',
    sourceUrl: 'https://thehill.com/policy/defense/5347224-trump-military-parade-criticism-cost/',
    lastVerified: '2026-06-08',
    category: 'defense',
    notes: 'Army estimates $25-45M for June 14 parade marking Army 250th anniversary & Trump 79th birthday; 150 vehicles, 28 tanks, 50 aircraft; additional $16M in street damage; 6 in 10 Americans say not a good use of money'
  },
  trending2: {
    label: 'Golden Dome Missile Defense (CBO Estimate)',
    value: 1_200_000_000_000,        // $1.2 trillion (CBO 20-year estimate)
    source: 'Congressional Budget Office / NPR',
    sourceUrl: 'https://www.cbo.gov/publication/62379',
    lastVerified: '2026-06-08',
    category: 'defense',
    notes: 'CBO May 2026 report: $1.2T over 20 years vs. White House $175B estimate; AEI estimates as high as $3.6T; Congress already allocated $13.4B for FY26 plus $24.4B in OBBBA; critics say may not work as advertised'
  },
  trending3: {
    label: 'Federal Improper Payments (FY2025)',
    value: 186_000_000_000,          // $186 billion (GAO FY2025 estimate)
    source: 'Government Accountability Office',
    sourceUrl: 'https://www.gao.gov/products/gao-26-108694',
    lastVerified: '2026-06-08',
    category: 'general',
    notes: 'GAO report: $186B in improper payments in FY25, up $24B from prior year; ~82% were overpayments; cumulative $3T since 2003; 19 programs had error rates >10%; House GOP pivoting to fraud as midterm issue'
  },
  trending4: {
    label: 'Education Funding Withheld by White House',
    value: 2_000_000_000,            // $2 billion (OMB withholding from Congress-approved funds)
    source: 'Education Week / CBS News',
    sourceUrl: 'https://www.edweek.org/policy-politics/white-house-blocks-2-billion-for-education-see-all-the-affected-programs/2026/05',
    lastVerified: '2026-06-08',
    category: 'general',
    notes: 'OMB withholding $2B+ Congress approved in February; affects teacher development, English learners, migrant kids, adult literacy; $1B+ will expire and return to Treasury if not released; legal/constitutional fight brewing'
  },
  trending5: {
    label: 'SNAP Cuts from "Big Beautiful Bill"',
    value: 186_000_000_000,          // $186 billion (CBO 10-year SNAP reduction)
    source: 'CBO / CBPP / CNBC',
    sourceUrl: 'https://www.cnbc.com/2026/05/30/snap-food-stamps-big-beautiful-bill.html',
    lastVerified: '2026-06-08',
    category: 'general',
    notes: 'Deepest SNAP cut in history: $186B over 10 years (20% cut); 3.5M+ already lost benefits since July 2025; California implementing 3-month time limit June 1; deepest hit to low-income food assistance',
    isSavings: true
  },
  trending6: {
    label: 'ACA/Obamacare Improper Enrollment Cost',
    value: 25_000_000_000,           // $25 billion (Paragon Institute estimate for 2026)
    source: 'Paragon Health Institute / The Hill',
    sourceUrl: 'https://paragoninstitute.org/private-health/the-persistent-obamacare-enrollment-fraud/',
    lastVerified: '2026-06-08',
    category: 'medicare',
    notes: 'Paragon June 2026 report: 6.2M (27%) of ACA sign-ups improper, costing taxpayers up to $25B in subsidies; concentrated in HealthCare.gov states; Florida >50% improper per analysis; figure is disputed/contested'
  },
  trending7: {
    label: 'Iran War Total Cost to U.S. Households',
    value: 100_000_000_000,          // $100 billion (Moody's June 2026 household cost estimate)
    source: 'Moody\'s / Fortune',
    sourceUrl: 'https://fortune.com/2026/06/02/iran-war-moodys-household-military-funding-oil-prices/',
    lastVerified: '2026-06-08',
    category: 'general',
    notes: 'Moody\'s: Iran war has cost U.S. households $100B / $750 per household combining military spending + higher oil prices; Pentagon admits $25B direct military cost; Dem estimates range $630B-$1T total economic burden'
  }
};
